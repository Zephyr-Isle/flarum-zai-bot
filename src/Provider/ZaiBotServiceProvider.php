...
class ZaiBotServiceProvider extends AbstractServiceProvider
{
    public function register(): void
    {
        ...
        $this->container->singleton(ExtensionIntegrationService::class);
    ...
    public function boot(ToolRegistry $tools, ExtensionIntegrationService $integrations): void
    {
        foreach ($integrations->toolDefinitions() as $name => $definition) {
            $tools->register($name, $definition);
        }
    }
}
