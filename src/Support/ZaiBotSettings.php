...
final class ZaiBotSettings
{
    ...
    public static function defaults(): array
    {
        return [
            ...
            self::key('use_separate_database') => '0',
            self::key('separate_db_connection') => 'zai_bot',
            self::key('separate_db_host') => '127.0.0.1',
            self::key('separate_db_port') => '5432',
            self::key('separate_db_database') => 'zai_bot',
            self::key('separate_db_username') => 'postgres',
            self::key('separate_db_password') => '',
            self::key('separate_db_prefix') => '',
            self::key('separate_db_sslmode') => 'prefer',
